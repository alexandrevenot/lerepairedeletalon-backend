...
async def create_and_send_contract(
    ...
    placeholder_fields.append({
        ...
        "value": build_company_identification_field(
            seller_document["contractual_identity"]["company_name"],
            seller_document["contractual_identity"]["company_status"],
            seller_document["contractual_identity"]["capital"],
            seller_document["contractual_identity"]["head_office_address"],
            seller_document["contractual_identity"]["siret"],
            seller_document["contractual_identity"]["gender"],
            seller_document["firstname"],
            seller_document["lastname"],
            seller_document["contractual_identity"]["postal_address"],
            seller_document["contractual_identity"]["birthdate"],
            seller_document["contractual_identity"]["birthplace"],
            seller_document["contractual_identity"]["citizenship"]
        )
    })
    
    if buyer_document["contractual_identity"]["type"] == "individual":
        placeholder_fields.append({
            "api_key": "buyer_identification",
            "value": build_person_identification_field(
                buyer_document["contractual_identity"]["gender"],
                buyer_document["firstname"],
                buyer_document["lastname"],
                buyer_document["contractual_identity"]["postal_address"],
                buyer_document["contractual_identity"]["birthdate"],
                buyer_document["contractual_identity"]["birthplace"],
                buyer_document["contractual_identity"]["citizenship"]
            )
        })
    elif buyer_document["contractual_identity"]["type"] == "company":
        placeholder_fields.append({
            "api_key": "buyer_identification",
            "value": build_company_identification_field(
                buyer_document["contractual_identity"]["company_name"],
                buyer_document["contractual_identity"]["company_status"],
                buyer_document["contractual_identity"]["capital"],
                buyer_document["contractual_identity"]["head_office_address"],
                buyer_document["contractual_identity"]["siret"],
                buyer_document["contractual_identity"]["gender"],
                buyer_document["firstname"],
                buyer_document["lastname"],
                buyer_document["contractual_identity"]["postal_address"],
