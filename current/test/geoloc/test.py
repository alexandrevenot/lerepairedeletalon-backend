...
class GeolocTest(unittest.TestCase):
    def test(self):
        ...
        self.assertEqual(result[0]["lat"], 50.2347)
        self.assertEqual(result[0]["lng"], 3.2127)
        self.assertEqual(result[1]["lat"], 49.6961)
        self.assertEqual(result[1]["lng"], 1.7651)
        ...
        self.assertEqual(result[1]["lat"], 46.8222)
        self.assertEqual(result[1]["lng"], 5.5868)
        self.assertEqual(result[1]["postal_code"], "39230")
